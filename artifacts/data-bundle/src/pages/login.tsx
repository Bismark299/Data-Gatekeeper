        ...
        <div className="bg-card rounded-2xl border border-border shadow-xl p-8">
          ...
          <div className="mt-5 pt-5 border-t border-border">
            <a
              ...
              className="flex items-center justify-center gap-2.5 w-full py-2.5 rounded-xl bg-[#25D366]/10 hover:bg-[#25D366]/20 transition-colors text-[#128C4A] font-medium text-sm"
            >
              <svg className="w-4 h-4 fill-[#128C4A]" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
